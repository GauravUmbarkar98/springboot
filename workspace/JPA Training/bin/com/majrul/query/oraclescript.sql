...
insert into items values(1, 'MARUTI 800', '', 125000, 150000, TO_DATE('2020-10-15', 'yyyy-mm-dd'))
insert into items values(2, 'MARUTI ESTEEM', '', 500000, 600000, TO_DATE('2020-10-20''yyyy-mm-dd'))
insert into items values(3, 'HYUNDAI ACCENT', '', 750000, 175000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(4, 'HYUANDAI SANTRO', '', 800000, 900000, TO_DATE('2020-10-25','yyyy-mm-dd'))
insert into items values(5, 'CHEVROLET OPTRA', '', 1200000, 1300000, TO_DATE('2020-10-30','yyyy-mm-dd'))
insert into items values(6, 'TOYOTA CAMRY', '', 1500000, 1600000, TO_DATE('2020-10-10','yyyy-mm-dd'))
insert into items values(7, 'SAHARA LAPTOP', '', 25000, 30000, TO_DATE('2020-10-15','yyyy-mm-dd'))
insert into items values(8, 'DELL INSPIRON', '', 450000, 50000, TO_DATE('2020-10-25','yyyy-mm-dd'))
insert into items values(9, 'SONY VAIO', '', 60000, 70000, TO_DATE('2020-10-30','yyyy-mm-dd'))
insert into items values(10, 'HCL PC', '', 20000, 22000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(11, 'WIPRO DESKTOP PC', '', 25000, 27000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(12, 'ACER WORKSTATION', '', 25000, 28000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(13, 'NOKIA 6600', '', 5000, 6000, TO_DATE('2020-10-15','yyyy-mm-dd'))
insert into items values(14, 'SONY W50I', '', 6000, 6500, TO_DATE('2020-10-25','yyyy-mm-dd'))
insert into items values(15, 'SAMSUNG D50', '', 7000, 7500, TO_DATE('2020-10-30','yyyy-mm-dd'))
insert into items values(16, 'IBM MOUSE', '', 250, 300, TO_DATE('2020-10-30','yyyy-mm-dd'))
insert into items values(17, 'MARUTI SWIFT', '', 125000, 150000, TO_DATE('2020-10-15','yyyy-mm-dd'))
insert into items values(18, 'MARUTI DZIRE', '', 500000, 600000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(19, 'HYUNDAI I10', '', 750000, 175000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(20, 'HYUANDAI I20', '', 800000, 900000, TO_DATE('2020-10-25','yyyy-mm-dd'))
insert into items values(21, 'CHEVROLET CRUZE', '', 1200000, 1300000, TO_DATE('2020-10-30','yyyy-mm-dd'))
insert into items values(22, 'TOYOTA COROLLA', '', 1500000, 1600000, TO_DATE('2020-10-10','yyyy-mm-dd'))
insert into items values(23, 'ASUS LAPTOP', '', 25000, 30000, TO_DATE('2020-10-15','yyyy-mm-dd'))
insert into items values(24, 'DELL 15R', '', 450000, 50000, TO_DATE('2020-10-25','yyyy-mm-dd'))
insert into items values(25, 'MSI NETBOOK', '', 60000, 70000, TO_DATE('2020-10-30','yyyy-mm-dd'))
insert into items values(26, 'HCL ME LAPTOP', '', 20000, 22000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(27, 'APPPLE MACBOOK', '', 25000, 27000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(28, 'APPLE IPHONE', '', 25000, 28000, TO_DATE('2020-10-20','yyyy-mm-dd'))
insert into items values(29, 'NOKIA 68200', '', 5000, 6000, TO_DATE('2020-10-15','yyyy-mm-dd'))
insert into items values(30, 'SONY VIVAZ', '', 6000, 6500, TO_DATE('2020-10-25','yyyy-mm-dd'))
insert into items values(31, 'SAMSUNG GALAXY', '', 7000, 7500, TO_DATE('2020-10-30','yyyy-mm-dd'))
insert into items values(32, 'HP MOUSE', '', 250, 300, TO_DATE('2020-10-30','yyyy-mm-dd'))
